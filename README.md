...
#### Counter-argument 5:
Ethereum and many of the newer blockchains (e.g. Avalanche, Solana, Cosmos, Terra, Binance Smart Chain, etc) do not use Proof-of-Work for consensus.
- Ethereum's Proof-of-Stake consensus algorithm will use at least ~99.95% less energy post merge and is expected to consume ~ 2.62 megawatt (around 2100 American homes).  [4](https://blog.ethereum.org/2021/05/18/country-power-no-more/)
- 
